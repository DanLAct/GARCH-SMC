function [h_predict, CI_low_h_t, CI_up_h_t, Predict_median_h_t, ELPD_LFO_true_var] = gjr_BayesPostPredict_volatility_sim(N, Sim_Var, theta, theta_particle, W)
%One-step ahead forecast of conditional variances together with LFO-CV under GJR-GARCH(1,1) model for Simulated Data, with using the output of parameters sampled from Data Annealing SMC
%%%%%%%%%%%%%%%%%%%% INPUT %%%%%%%%%%%%%%%%%%%%
...
%load('Prediction_TrueGjr_unif_sim.mat');
%load('Data_Sims_unif_gjr_h_gjr.mat');

%loading simulated data
load('Data_Sims_gjr.mat');
...
parfor t=1:PT
    ...
    [likelihood_predict_TureData_var(t),x] = ksdensity(h_t,h_gjr(start+t),'Weights',W(:,start+t));
...
save('gjr_BayesPostPredict_SimulatedData_ELPD_var.mat');
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
