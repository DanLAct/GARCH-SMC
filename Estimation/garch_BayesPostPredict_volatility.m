function [h_predict, CI_low_h_t, CI_up_h_t, Predict_median_h_t] = garch_BayesPostPredict_volatility(N, theta, theta_particle, W)
%One-step ahead forecast of conditional variances under GARCH(1,1) model for Real Data, with using the output of parameters sampled from Data Annealing SMC
%%%%%%%%%%%%%%%%%%%% INPUT %%%%%%%%%%%%%%%%%%%%
...
%load('Data for Prediction_garch_unif.mat');
...
save('garch_BayesPostPredict_RealData_var.mat');
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
