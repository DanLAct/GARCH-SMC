function [h_predict, CI_low_h_t, CI_up_h_t, Predict_median_h_t, ELPD_LFO_true_var] = bege_BayesPostPredict_volatility_sim_unbiased_is(N, Sim_Var, theta, theta_particle, W)
...
load('Data_Sims.mat'); %Simulated data from BEGE model; can be changed to simulated data from other models as desired
...
%save('results_BayesPostPredict_SimulatedData_ELPD_var_unbiased.mat');
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
